package com.csi3370.paperstocks.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.csi3370.paperstocks.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.csi3370.paperstocks.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
