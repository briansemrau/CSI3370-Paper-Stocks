...
public class TransactionResourceIntTest {
    ...
    private static final Double DEFAULT_PRICE_PER_SHARE = 1D;
    private static final Double UPDATED_PRICE_PER_SHARE = 2D;
    ...
    public void createTransaction() throws Exception {
        ...
        assertThat(testTransaction.getTicker()).isEqualTo(DEFAULT_TICKER);
        assertThat(testTransaction.getQuantity()).isEqualTo(DEFAULT_QUANTITY);
        assertThat(testTransaction.getPricePerShare()).isEqualTo(DEFAULT_PRICE_PER_SHARE);
    ...
    @Test
    @Transactional
    public void checkPricePerShareIsRequired() throws Exception {
        int databaseSizeBeforeTest = transactionRepository.findAll().size();
        // set the field null
    ...
    public void getAllTransactions() throws Exception {
        ...
        restTransactionMockMvc.perform(get("/api/transactions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].pricePerShare").value(hasItem(DEFAULT_PRICE_PER_SHARE.doubleValue())))
    ...
    public void getTransaction() throws Exception {
        ...
        restTransactionMockMvc.perform(get("/api/transactions/{id}", transaction.getId()))
            ...
            .andExpect(jsonPath("$.pricePerShare").value(DEFAULT_PRICE_PER_SHARE.doubleValue()))
    ...
    public void updateTransaction() throws Exception {
        ...
        updatedTransaction
            ...
            .pricePerShare(UPDATED_PRICE_PER_SHARE)
            .date(UPDATED_DATE);
        ...
        Transaction testTransaction = transactionList.get(transactionList.size() - 1);
        assertThat(testTransaction.getTicker()).isEqualTo(UPDATED_TICKER);
        assertThat(testTransaction.getQuantity()).isEqualTo(UPDATED_QUANTITY);
        assertThat(testTransaction.getPricePerShare()).isEqualTo(UPDATED_PRICE_PER_SHARE);
